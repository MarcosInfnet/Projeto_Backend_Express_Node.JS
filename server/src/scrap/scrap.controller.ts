...
@Get("/owner/:ownerId")
@Authorized()
async listOwnerScraps(@Param("ownerId") ownerId : number ,@CurrentUser() user : User){
...
@Post()
@Authorized()
async createScrap(@Body() createScrapDto : CreateScrapDto , @CurrentUser() user : User ){
...
@Put("/:scrapId")
@Authorized()
async updateScrap(@Param("scrapId") scrapId : string , @Body() updateScrapDto : UpdateScrapDto , @CurrentUser() user : User ){
...
@Delete("/:scrapId")
@Authorized()
async deleteScrap(@Param("scrapId") scrapId: string, @CurrentUser() user: User) {
